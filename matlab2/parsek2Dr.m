...
for i=1:Nprocs
 cart=hdf5read(['/home/gianni/cluster/storage/parsek/lhdi1/proc',num2str(i-1),'.hdf'],'/topology/cartesian_coord');
 MAP(cart(1)+1,cart(2)+1)=hdf5read(['/home/gianni/cluster/storage/parsek/lhdi1/proc',num2str(i-1),'.hdf'],'/topology/cartesian_rank')+1;
end
