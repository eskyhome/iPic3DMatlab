function [ym] = coplot(x,y,f,ay,xlab,ylab,tit,lmt)
global contours
...
gg=pcolor(x(lmt(1):lmt(2)),y(lmt(3):lmt(4)),f(lmt(1):lmt(2),lmt(3):lmt(4)));
end
...
ff=contour(x(lmt(1):lmt(2)),y(lmt(3):lmt(4)),ay2(lmt(1):lmt(2),lmt(3):lmt(4)),30,'w');
end
end
