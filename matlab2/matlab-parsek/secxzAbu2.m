...
coplot(xx,yy,jsz0+jszb,ay,'x/d_i','y/d_i',['J_{ze}(\omega_{ci}t=' num2str(time(it)) ')'],lmt)
...
coplot(xx,yy,(rrho+rrhob)*4*pi,ay,'x/d_i','y/d_i',['\rho_{e}(\omega_{ci}t=' num2str(time(it)) ')'],lmt)
...
coplot(xx,yy,upar/vthe,ay,'x/d_i','y/d_i',['U_{e||}/v_{the0}(\omega_{ci}t=' num2str(time(it)) ')'],lmt)
...
coplot(xx,yy,rrhob*4*pi,ay,'x/d_i','y/d_i',['\rho_b(\omega_{ci}t=' num2str(time(it)) ')'],lmt)
...
h=figure(6);
set(h,'Position' , [1125 550 560 420]);
coplot(xx,yy,(jsx0+jsxb)./(rrho+rrhob)/vthe,ay,'x/d_i','y/d_i',['V_{ex}/v_{the0}(\omega_{ci}t=' num2str(time(it)) ')'],lmt)
