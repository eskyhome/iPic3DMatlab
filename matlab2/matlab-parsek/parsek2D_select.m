...
%results_dir='/kinetic/newman/Lapenta/run48/mms256/' ; % directory for results
...
%%   cycle_list=str2double(regexprep(info.GroupHierarchy.Groups(1).Groups(1).Datasets(time_counter_list).Name,'/energy/electric/cycle_',''))
