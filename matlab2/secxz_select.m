...
print('-dpng',['film1/' num2str(cycle_list(indexf),'%3.3i')])
...
set(gcf, 'Renderer', 'zbuffer');
print('-dpng',['film2/' num2str(cycle_list(indexf),'%3.3i')])
...
set(gcf, 'Renderer', 'zbuffer');
print('-dpng',['film3/' num2str(cycle_list(indexf),'%3.3i')])
...
set(gcf, 'Renderer', 'zbuffer');
print('-dpng',['film4/' num2str(cycle_list(indexf),'%3.3i')])
...
set(gcf, 'Renderer', 'zbuffer');
print('-dpng',['film5/' num2str(cycle_list(indexf),'%3.3i')])
...
set(gcf, 'Renderer', 'zbuffer');
print('-dpng',['film6/' num2str(cycle_list(indexf),'%3.3i')])
